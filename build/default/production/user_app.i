...
void UserAppRun(void)
{
    u8 G_au8UserAppTwinkle_Twinkle[] = {(u16)(u16)60, (u16)(u16)60, (u16)(u16)40, (u16)(u16)40, (u16)(u16)36, (u16)(u16)36, (u16)(u16)40, (u16)(u16)45, (u16)(u16)45, (u16)(u16)47, (u16)(u16)47, (u16)(u16)53, (u16)(u16)53};
    u16 G_au16UserAppTwinkle_Twinkle_Note_Type[] = {(u16)((u16)2048 / 4), (u16)((u16)2048 / 4), (u16)((u16)2048 / 4), (u16)((u16)2048 / 4), (u16)((u16)2048 / 4), (u16)((u16)2048 / 4), (u16)((u16)2048 / 2), (u16)((u16)2048 / 4), (u16)((u16)2048 / 4), (u16)((u16)2048 / 4), (u16)((u16)2048 / 4), (u16)((u16)2048 / 4), (u16)((u16)2048 / 4)};
    u16 u16Note_timeus = 0x0000;





    InterruptTimerXus((G_au8UserAppTwinkle_Twinkle[UserApp_u8index])*1.89,1);
    u16Note_timeus = G_au16UserAppTwinkle_Twinkle_Note_Type[UserApp_u8index]*0x03e8;


    {
    }
    _delay((unsigned long)((u16Note_timeus)*(32000000/4000000.0)));
    UserApp_u8index += 0x01;

    if(UserApp_u8index == 13){
        UserApp_u8index = 0x00;
    }
