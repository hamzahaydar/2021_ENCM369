...
void UserAppRun(void)
{
    ...
    u16 G_au16UserAppTwinkle_Twinkle[] = {C4, C4, G4, G4, A4, A4, G4, F4, F4, E4, E4, D4, D4,C4,NN,G4,G4,F4,F4,E4,E4,D4,G4,G4,F4,F4,E4,E4,D4}; // Initializes an array of notes of Hotline Bling(the (u16)0x004f is the A note below C4)
    u16 G_au16UserAppTwinkle_Twinkle_Note_Type[] = {N4, N4, N4, N4, N4, N4, N2, N4, N4, N4, N4, N4, N4,N4,N4,N4, N4, N4, N4, N4,N2,N4, N4, N4, N4, N4, N4,N4,N2}; // Initializes an array of note lengths of Hotline Bling
    
    InterruptTimerXus(G_au16UserAppTwinkle_Twinkle[UserApp_u16index],true); // sets frequency of selected note from array
    
    u16duration++; // Increment duration count
    
    if(u16duration == (G_au16UserAppTwinkle_Twinkle_Note_Type[UserApp_u16index] - REGULAR_NOTE_ADJUSTMENT)) // When the duration hits the note duration of the corresponding note: 
    {
        UserApp_u16index++; // increment to next note in array
        u16duration = 0x00; // reset note duration
    
     for(u16 i = 0x0000; i < REGULAR_NOTE_ADJUSTMENT; i++) //  end of the note adjustment
        {
    ...
    if(UserApp_u16index == 0X001D) // restart song
    {
